...
The maintainer of the project is Filatov Dmitry.
...
If you found an error, mistype or any other flawback in the project, please report about it using [issues](https://github.com/dfilatov/jspromise/issues).
...
If you cannot implement the feature, but it is very important, you can add a task in [issues](https://github.com/dfilatov/jspromise/issues), but expect it be declined by the maintainer.
